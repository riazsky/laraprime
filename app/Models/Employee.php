...
class Employee extends Model
{
    ...
    protected $fillable = ['department_id', 'designation_id', 'shift_id', 'full_name', 'email', 'phone', 'present_address', 'join_date', 'duty_type', 'salary_type', 'status', 'employee_unique_id'];
    /**
